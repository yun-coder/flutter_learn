...
class CustomOrderToCart extends StatefulWidget {
  const CustomOrderToCart({super.key});

  @override
  State<CustomOrderToCart> createState() => _OrderToCart();
}

class _OrderToCart extends State<CustomOrderToCart>
  ...
  Widget _buildMenuItem({required Item item}) {
    return LongPressDraggable<Item>(
        data: item,
        dragAnchorStrategy: pointerDragAnchorStrategy, // 拖拽锚定策略
        feedback: DraggingListItem(
            dragkey: _draggableKey, imageProvider: item.imageProvider),
        child: MenuListItem(
...
class Customer {
  ...
  String get formattedTotalItemPrice {
    final totalPriceCents =
        items.fold<int>(0, (prev, element) => prev + element.totalPriceCents);
